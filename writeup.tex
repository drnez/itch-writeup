...
\begin{enumerate}
    ...
    \item There should be no central server the package manager needs to interact with to function. It should be able to run wholly locally, with no limitations.
...
I chose the name \textit{Itch} for this package manager to reflect the importance of Aim \ref{TargetLFS}, since it is based on Linux From \textit{Scratch}.

\subsection{Existing methods}

Through my research of existing package managers, I have identified 
